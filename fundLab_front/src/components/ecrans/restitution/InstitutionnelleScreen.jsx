      ...
      <section className="section bg-light" style={{ borderRadius: '16px', padding: '32px 24px', marginBottom: '32px', background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
        <div className="container">
          ...
          <div className="grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px' }}>
            <div className="card" style={{ background: '#FFFFFF', padding: '24px', borderRadius: '16px', border: '1px solid #E2E8F0', boxShadow: '0 2px 8px rgba(0,0,0,0.02)' }}>
              ...
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#1E293B', marginBottom: '8px' }}>Démocratiser l'accès</h3>
              <p style={{ fontSize: '0.9rem', color: '#64748B', lineHeight: '1.5', margin: 0 }}>Permettre à chaque créateur de projet ou dirigeant de PME d'accéder sans frais à des outils d'audit d'un niveau digne des plus grands cabinets conseils.</p>
            </div>
            <div className="card" style={{ background: '#FFFFFF', padding: '24px', borderRadius: '16px', border: '1px solid #E2E8F0', boxShadow: '0 2px 8px rgba(0,0,0,0.02)' }}>
              <div className="card-icon" style={{ color: 'var(--color-blue)', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '48px', width: '48px', borderRadius: '12px', background: 'rgba(52, 190, 213, 0.1)', marginBottom: '16px' }}>
                <FileText size={24} />
              </div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#1E293B', marginBottom: '8px' }}>Recommandations concrètes</h3>
              <p style={{ fontSize: '0.9rem', color: '#64748B', lineHeight: '1.5', margin: 0 }}>Fournir un plan d'action balisé plutôt qu'une simple note. Chaque indicateur est corrélé à une opportunité d'optimisation.</p>
            </div>
            <div className="card" style={{ background: '#FFFFFF', padding: '24px', borderRadius: '16px', border: '1px solid #E2E8F0', boxShadow: '0 2px 8px rgba(0,0,0,0.02)' }}>
              <div className="card-icon" style={{ color: 'var(--color-blue)', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '48px', width: '48px', borderRadius: '12px', background: 'rgba(52, 190, 213, 0.1)', marginBottom: '16px' }}>
                <Handshake size={24} />
              </div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#1E293B', marginBottom: '8px' }}>Créer un écosystème</h3>
              <p style={{ fontSize: '0.9rem', color: '#64748B', lineHeight: '1.5', margin: 0 }}>Connecter les entreprises auditées avec les meilleurs accompagnateurs locaux pour initier et sécuriser leur croissance long terme.</p>
            </div>
          </div>
        </div>
      </section>
