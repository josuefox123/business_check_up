              ...
              <div className="admin-modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  <div className="admin-form-group">
                    <label className="admin-form-label">Identifiant unique (ID)</label>
                    <input 
                      type="text" 
                      value={qId} 
                  ...
                  <div className="admin-form-group">
                    <label className="admin-form-label">Axe diagnostique / Dimension</label>
                    <input 
                      type="text" 
                      value={qAxe} 
                      onChange={e => setQAxe(e.target.value)} 
                      className="admin-form-input"
                      placeholder="Ex: Finance, Commercial, Gouvernance..."
                    />
                  </div>
                </div>
                ...
                <div className="admin-form-group">
                  ...
                  <input 
                    ...
                    className="admin-form-input" 
                    placeholder="Saisissez le texte complet de la question..."
                    required
                  />
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  <div className="admin-form-group">
                    ...
                    <select value={qType} onChange={e => setQType(e.target.value)} className="admin-form-select">
                      <option value="single">Choix unique (Boutons radio)</option>
                      <option value="multi">Choix multiples (Cases à cocher)</option>
                      <option value="scale_1_5">Curseur d'échelle linéaire (1 à 5)</option>
                    </select>
                  </div>
                  <div className="admin-form-group">
                    <label className="admin-form-label">Coefficient / Coefficient de pondération</label>
                    <input 
                      type="number" 
                      value={qWeight} 
                ...
                {qType !== 'scale_1_5' && (
                  <div style={{ marginTop: '8px', borderTop: '1px solid #f1f5f9', paddingTop: '16px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                      <h4 style={{ fontSize: '0.85rem', fontWeight: 800, color: '#334155', margin: 0 }}>Options de choix de réponse</h4>
                      <button className="btn btn-ghost btn-sm" type="button" onClick={addChoice} style={{ color: 'var(--color-blue)', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
